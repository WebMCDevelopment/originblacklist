...
import xyz.webmc.originblacklist.core.logger.SLF4JLogger;
...
public final class OriginBlacklistVelocityPlugin implements IOriginBlacklistPlugin {
  ...
  @Inject
  public OriginBlacklistVelocityPlugin(final PluginContainer plugin, Factory metricsFactory, final ProxyServer proxy,
      final Logger logger) {
    this.plugin = plugin;
